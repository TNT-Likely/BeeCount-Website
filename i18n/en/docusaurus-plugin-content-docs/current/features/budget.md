...
Set budgets for specific categories, such as:
...
- Warning displayed when over budget

## Budget Cycle

Budgets are calculated by calendar month and automatically reset on the 1st of each month.
